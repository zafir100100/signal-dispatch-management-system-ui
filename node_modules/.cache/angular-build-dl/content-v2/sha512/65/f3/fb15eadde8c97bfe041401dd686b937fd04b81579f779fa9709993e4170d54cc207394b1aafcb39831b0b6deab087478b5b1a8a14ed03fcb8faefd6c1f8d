...
UserListComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UserListComponent, selectors: [["app-user-list"]], decls: 5, vars: 0, consts: [[1, ""]], template: function UserListComponent_Template(rf, ctx) { if (rf & 1) {
